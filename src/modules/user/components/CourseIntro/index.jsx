...
export function CourseIntro({ courseData, lessonData }) {
    ...
    <div className="bg-[#253144] rounded-2xl border border-slate-500 p-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex items-center text-slate-300">
          <Clock className="w-5 h-5 mr-2" />
          <span>
            {currentLesson.duration || course.total_duration || "45 phút"}
          </span>
        </div>
      </div>

      {/* Course Features - Hard-coded, có thể mở rộng từ backend */}
      <div className="flex items-center space-x-6 text-sm">
        <div className="flex items-center text-white">
          <BookOpen className="w-4 h-4 mr-2" />
          <span>Tài liệu học tập</span>
