    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => setNewPassword(e.target.value)}
              placeholder="Your New Password"
              className="w-full px-4 pr-10 py-2 border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 bg-transparent text-white placeholder-white"
              required
            />
            <button
              type="button"
        ...
        <ul className="mt-2 text-sm list-disc list-inside space-y-1">
          ...
          <li
            className={
              hasUppercase && hasLowercase ? "text-green-400" : "text-red-500"
            }
          >
            Include uppercase & lowercase
          </li>
          <li className={hasNumber ? "text-green-400" : "text-red-500"}>
            Include numbers
          </li>
          <li className={hasSpecialChar ? "text-green-400" : "text-red-500"}>
            Include special characters
          </li>
        </ul>
      </div>
      ...
      <button
        type="submit"
        className="w-full py-3 rounded-xl font-bold text-white bg-gradient-to-r from-purple-600 to-purple-800 hover:opacity-90 transition"
      >
        Create New Password
      </button>
    </form>
