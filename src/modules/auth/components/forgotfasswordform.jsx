...
const ForgotPasswordForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="text-sm text-white block mb-1 [font-family:'Open_Sans',Helvetica] font-bold">
          User Name
        </label>
        <input
          type="text"
          ...
          onChange={(e) => setUsername(e.target.value)}
          placeholder="Your User Name"
          className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 bg-transparent text-white placeholder-white"
          required
        />
      </div>
