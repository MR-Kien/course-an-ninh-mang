      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-24">
        <div className="flex items-center justify-between h-18 py-4">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <a href="#ctf" className="text-white/80 hover:text-white font-bold text-base transition-colors">
              CTF
            </a>
            <a href="#about" className="text-white/80 hover:text-white font-bold text-base transition-colors">
              Giới thiệu
            </a>
            <a href="#contact" className="text-white/80 hover:text-white font-bold text-base transition-colors">
              <img src={AIchat} alt="AI chat" className="h-10 w-10 inline-block" />
            </a>
          </nav>
